...
/**
 * Model class for favourite documents on its firebase collection.
 * This contains the recipe's id reference, the recipe's data should be obtained using the id
 * after obtaining the favourite entries.
 */
public class Favourite implements Parcelable {
    private String id;
    private String username;
    private String recipeId;
    // Auto assigned value by firebase when its uploaded to database.
    @ServerTimestamp
    private Date additionDate;

    /**
     * Constructor used before uploading a favourite element to firebase.
     * @param id - the id generated by its document reference.
     * @param username - the user who added the recipe to favourites.
